...
st.write("This app uses 6 inputs to predict the species of penguin using" 
         "a model built on the Palmer Penguins dataser. Use the form below" 
         "to get started!")
with open('random_forest_penguin.pickle', 'rb') as rf_pickle:
    try:
        ...
        print("Type of loaded object:", type(rfc))
        print("Loaded object:", rfc)
        
    except pickle.UnpicklingError as e:
        print("An error occurred while unpickling the object:", e)
